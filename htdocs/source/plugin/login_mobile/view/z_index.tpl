...
<head>
  ...
  <script src="<%plugin_path%>/view/js/plugin/plat_login.js" charset="utf-8"></script>
  <%js_script%>
  <script>
...
-->
  ...
  <table class="tb tb2">
    <tr><th colspan="4" class="partition">第三方登录链接</th></tr>
    <tr><td colspan='4' style='color:gray;'>
      （您可以在移动端的登录页面上添加QQ，微信或其他登录链接）
    </td></tr>
    <tr class='header'>
      <td width='100'>显示顺序</td>
      <td width='150'>登录平台</td>
      <td width='150'>按钮标题</td>
      <td width='350'>登录链接</td>
      <td></td>
    </tr>
    ...
    <tr>
      <td colspan='4'>
        <button id='addbtn' class='mwt-btn mwt-btn-default mwt-btn-xs'>添加</button>&nbsp;&nbsp;
        <button id='subbtn' class='mwt-btn mwt-btn-default mwt-btn-xs'>提交</button>&nbsp;&nbsp;
