...
class plugin_login_mobile_member extends plugin_login_mobile
{
    ...
    function register_input()
    {
        ...
        $content = MobileLogin_Utils::getTemplate(dirname(__FILE__)."/template/regist.tpl",$vars,$tplVars);
        $content.= MobileLogin_Utils::getTemplate(dirname(__FILE__)."/template/smsdialog.tpl",$vars,$tplVars);
        return $content;
    }
    ...
    function register()
    {
        ...
        if (isset($_GET["inajax"]) && $_GET["inajax"]==1) {
            ...
            define('NOROBOT', TRUE);
            require_once dirname(__FILE__)."/libs/my_register_ctl.class.php";
