  ...
  <div id="layer_lostpw_LqcK7" style="display: none;">
    ...
    <div class="c cl">
	  ...
	  <div class="rfm">
        <table>
          <tr>
            <th><span class="rq">*</span><label for="lostpw_email">验证码:</label></th>
            <td>
              <input id="findpass_sms_seccode_txt" type="text" style="ime-mode:disabled;width:100px" class="txt px vm"/> 
              <a href="javascript:findpass_sms_new_seccode();" class="xi2">换一个</a><br>
              <span>输入下图中的字符</span><br>
              <img id="findpass_sms_seccode_img" onclick="findpass_sms_new_seccode();" width="100" height="30" src="<%plugin_path%>/index.php?version=4&module=seccode"
...
$('phone_aKnMp').focus();
  ...
  function sendsmscode() {
	  ...
	  var dom=document.getElementById("findpass_sms_seccode_txt");
      var seccode=my_trim_string(dom.value);
      if (seccode=="") {
		  dom.value="";
          dom.focus();
          return;
      }
      var params={phone:phone,seccode:seccode};
      console.log(params);
      leftseconds=60;
      disable_smsbtn();
      //alert("send");
      ...
      jq.ajax({
          type: "post",
          async: true,
          url: "<%plugin_path%>/index.php?version=4&module=smscode",
		  data: params,
		  dataType: "json",
  ...
  function findpass_sms_new_seccode() {
      var url = "<%plugin_path%>/index.php?version=4&module=seccode&tm="+new Date().getTime();
      document.getElementById("findpass_sms_seccode_img").src=url;
  }
</script>]]></root>
